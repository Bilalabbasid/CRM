      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <KPICard
            ...
            value={executiveSummary?.yesterday?.revenue || 12500}
            format="currency"
            change={executiveSummary?.yesterday?.growth || 5.2}
            trend="up"
          ...
          <KPICard
            ...
            value={executiveSummary?.thisWeek?.revenue || 87500}
            format="currency"
            change={executiveSummary?.thisWeek?.growth || 8.7}
            trend="up"
          ...
          <KPICard
            ...
            value={executiveSummary?.thisMonth?.revenue || 350000}
            format="currency"
            change={executiveSummary?.thisMonth?.growth || 12.3}
            trend="up"
          ...
          <KPICard
            ...
            value={executiveSummary?.pendingApprovals?.length || 3}
            format="number"
            trend="neutral"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <KPICard 
            ...
            value={businessData?.revenue?.year || 4200000}
            format="currency"
            change={((businessData?.revenue?.year - businessData?.revenue?.lastYear) / businessData?.revenue?.lastYear * 100) || 10.5}
            trend="up"
            icon={<DollarSign className="w-6 h-6" />}
          ...
          <KPICard 
            ...
            value={branchPerformance?.branches?.length || 4}
            format="number"
            trend="neutral"
